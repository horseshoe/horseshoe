...
public class ArrayTests {
	...
	public void testArrayLengthNamedExpr() throws IOException, LoadException {
		assertEquals("5", new TemplateLoader().load("Test", "{{a -> a.length}}{{a([\"a\": arr])}}").render(new Settings(), Collections.singletonMap("arr", new int[] { 1, 2, 3, 4, 5 }), new StringWriter()).toString());
	}
