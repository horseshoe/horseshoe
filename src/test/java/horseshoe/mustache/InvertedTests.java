...
class InvertedTests {
	...
	void test() throws horseshoe.LoadException, java.io.IOException {
		...
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^boolean}}This should be rendered.{{/boolean}}\"", Helper.loadMap("boolean", false), Helper.loadMap(), "\"This should be rendered.\""));

		/* Truthy - Truthy sections should have their contents omitted. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^boolean}}This should not be rendered.{{/boolean}}\"", Helper.loadMap("boolean", true), Helper.loadMap(), "\"\""));

		/* Context - Objects and hashes should behave like truthy values. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^context}}Hi {{name}}.{{/context}}\"", Helper.loadMap("context", Helper.loadMap("name", "Joe")), Helper.loadMap(), "\"\""));

		/* List - Lists should behave like truthy values. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^list}}{{n}}{{/list}}\"", Helper.loadMap("list", Helper.loadList(Helper.loadMap("n", "1"), Helper.loadMap("n", "2"), Helper.loadMap("n", "3"))), Helper.loadMap(), "\"\""));

		/* Empty List - Empty lists should behave like falsey values. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^list}}Yay lists!{{/list}}\"", Helper.loadMap("list", Helper.loadList()), Helper.loadMap(), "\"Yay lists!\""));
		...
		assertDoesNotThrow(() -> Helper.executeMustacheTest("| A {{^bool}}B {{^bool}}C{{/bool}} D{{/bool}} E |", Helper.loadMap("bool", false), Helper.loadMap(), "| A B C D E |"));

		/* Nested (Truthy) - Nested truthy sections should be omitted. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("| A {{^bool}}B {{^bool}}C{{/bool}} D{{/bool}} E |", Helper.loadMap("bool", true), Helper.loadMap(), "| A  E |"));

		/* Context Misses - Failed context lookups should be considered falsey. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("[{{^missing}}Cannot find key 'missing'!{{/missing}}]", Helper.loadMap(), Helper.loadMap(), "[Cannot find key 'missing'!]"));

		/* Dotted Names - Truthy - Dotted names should be valid for Inverted Section tags. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^a.b.c}}Not Here{{/a.b.c}}\" == \"\"", Helper.loadMap("a", Helper.loadMap("b", Helper.loadMap("c", true))), Helper.loadMap(), "\"\" == \"\""));

		/* Dotted Names - Falsey - Dotted names should be valid for Inverted Section tags. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^a.b.c}}Not Here{{/a.b.c}}\" == \"Not Here\"", Helper.loadMap("a", Helper.loadMap("b", Helper.loadMap("c", false))), Helper.loadMap(), "\"Not Here\" == \"Not Here\""));

		/* Dotted Names - Broken Chains - Dotted names that cannot be resolved should be considered falsey. */
		assertDoesNotThrow(() -> Helper.executeMustacheTest("\"{{^a.b.c}}Not Here{{/a.b.c}}\" == \"Not Here\"", Helper.loadMap("a", Helper.loadMap()), Helper.loadMap(), "\"Not Here\" == \"Not Here\""));
		...
		assertDoesNotThrow(() -> Helper.executeMustacheTest(" {{^boolean}}NO{{/boolean}}\n {{^boolean}}WAY{{/boolean}}\n", Helper.loadMap("boolean", false), Helper.loadMap(), " NO\n WAY\n"));
		...
		assertDoesNotThrow(() -> Helper.executeMustacheTest("|{{^ boolean }}={{/ boolean }}|", Helper.loadMap("boolean", false), Helper.loadMap(), "|=|"));
	}
