...
public class TemplateTests {
	...
	public void testSections() throws IOException, LoadException {
		...
		assertEquals("Big, Medium, Small, Zero", new TemplateLoader().load("Else If Test", "{{# [1000000, 1000, 1, 0] }}{{# .index }}, {{/}}{{# . > 65536 }}Big{{^# . > 64 }}Medium{{^# . > 0 }}Small{{^}}Zero{{/}}{{/}}").render(new Settings(), Collections.<String, Object>emptyMap(), new java.io.StringWriter()).toString());
	}
